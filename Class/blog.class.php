  ...
  class Blog
  {
    ...
    history.back();
        ...
        try {
          ...
          $sql = "UPDATE tbl_blog SET meta_title=?, meta_keywords=?, meta_description=?, section_1_img_1=?, section_1_image_alt_1=?, section_1_img_2=?, section_1_image_alt_2=?, section_1_conteudo_3=?, section_1_conteudo_4=? WHERE id=?";
          $stm = $this->pdo->prepare($sql);
