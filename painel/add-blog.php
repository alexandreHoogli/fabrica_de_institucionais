                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                                <label class="col-form-label">Imagem página do Blog (856x530)</label>
                                        ...
                                        <hr>
                                        <br>
                                        <h4 class="card-title">Conteúdo (parte 1)</h4>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-7 col-sm-12">
                                                <label class="col-form-label">Título CTA</label>
                                        ...
                                        <hr>
                                        <br>
                                        <h4 class="card-title">Conteúdo (parte 2)</h4>
                                        <div class="form-group row">
                                            <div class="col-md-12 col-sm-12">
                                                <label class="col-form-label">Texto</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                                <label class="col-form-label">Imagem CTA</label>
                                                <input class="form-control" type="file" name="imagem_cta" />
                                            </div>
                                             <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <label class="col-form-label">URL AMIGAVEL (é gerada com base no título)</label>
