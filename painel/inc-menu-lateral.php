<aside class="left-sidebar" data-sidebarbg="skin6">
    <div class="scroll-sidebar" data-sidebarbg="skin6">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        <li class="sidebar-item"><a href="usuarios.php" class="sidebar-link"><span class="hide-menu">
                                    Listar Usuários </span></a></li>
                        <li class="sidebar-item"><a href="add-usuario.php" class="sidebar-link"><span class="hide-menu">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <i data-feather="file-text" class="feather-icon"></i>
                <span class="hide-menu">Desc_colunista</span>
            </a>
            <ul aria-expanded="false" class="collapse first-level base-level-line">
                <li class="sidebar-item"><a href="desc_colunista.php" class="sidebar-link"><span class="hide-menu">
                    Listar Desc_colunista</span></a></li>
                <li class="sidebar-item"><a href="add-desc_colunista.php" class="sidebar-link"><span class="hide-menu">
                    Adicionar desc_colunista</span></a></li>
            </ul>
        </li>
        
        <li class="sidebar-item"> <a class="sidebar-link" href="editar-colunistas.php?pi=S&id=1"> 
            <i data-feather="file-text" class="feather-icon"></i>Colunistas</a>
        </li>

        
        <li class="sidebar-item"> <a class="sidebar-link" href="editar-livros.php?pi=S&id=1"> 
            <i data-feather="file-text" class="feather-icon"></i>Livros</a>
        </li>
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                <i data-feather="file-text" class="feather-icon"></i>
                <span class="hide-menu">Desc_livro</span>
            </a>
            <ul aria-expanded="false" class="collapse first-level base-level-line">
                <li class="sidebar-item"><a href="desc_livro.php" class="sidebar-link"><span class="hide-menu">
                    Listar Desc_livro</span></a></li>
                <li class="sidebar-item"><a href="add-desc_livro.php" class="sidebar-link"><span class="hide-menu">
                    Adicionar desc_livro</span></a></li>
            </ul>
        </li>
        ...
        <li id="aqui" class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                    ...
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        ...
                        <li class="sidebar-item"><a href="pastas.php" class="sidebar-link"><span class="hide-menu">
                                    Linkagem
                                </span></a>
                        </li>
                        <li class="sidebar-item"><a href="metas-tags.php" class="sidebar-link"><span class="hide-menu">
                                    Metas Tags
                                </span></a>
                        </li>
                    </ul>
